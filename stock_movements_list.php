...
function updateSummary(data) {
    ...
    if (data && Array.isArray(data)) {
        data.forEach(row => {
            ...
            // ✅ ถ้า reference_type = TRANSFER → นับเป็น TRANSFER
            if (refType === 'TRANSFER') {
                summary.TRANSFER++;
            } 
    ...
    data.forEach((row, index) => {
        ...
        html += `
            <tr>
                ...
                <td style="text-align: right;"><strong>${parseFloat(row.quantity || 0).toFixed(2)}</strong> ${row.unit_symbol || ''}</td>
        ...
        if (result.success && result.data) {
            ...
            let html = `
                <div class="detail-grid">
                    ...
                    <div class="detail-item">
                        <label>จำนวน</label>
                        <div class="value">${parseFloat(data.quantity || 0).toFixed(2)} ${data.unit_symbol || ''}</div>
                    </div>
                    <div class="detail-item">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="value">${data.quantity_kg ? parseFloat(data.quantity_kg).toFixed(2) : '-'}</div>
                    </div>
                    <div class="detail-item">
